...
# or:
#   Rscript scripts/build_triplets.R /path/to/032_cis_mediation_fdr20
#
...
# Output: results/cis_trans_triplets_all.tsv
...
out_file <- file.path(base_dir, "results", "winter", "cis_trans_triplets_all.tsv")
...
message("Determining overlapping SNPs for cis and trans (no FDR filter)...")
...
message("Building all cis–trans gene triplets per overlapping SNP...")
setkey(cis_dt, snps)
...
message("Constructed ", nrow(triplets_out), " SNP–cis–trans triplets. Writing to: ", out_file)
